...
public class uvPlayer {     // TARGETABLE!!    
    ...
    private List<String> managerNames = new ArrayList<String>();    // Database of names of managers, supervising THIS
    private List<uvManager> managers = new ArrayList<uvManager>();  // Array of Manager Class Instances
