...
{     // TARGETABLE!!
	...
	};   // look at ultravision.java for flag list, firt array is the managerID
	...
	{
		base.sendMessage( ChatColor.DARK_GRAY + "[UV] " + ChatColor.WHITE + msg );
	}
	...
	// FOR TARGET
	public void setAsTarget( boolean state )
	{
		this.isTarget = state;
	}
